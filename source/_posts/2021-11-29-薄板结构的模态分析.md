...
(1) 变形前垂直于中面的直线变形后仍然保持直线，而且长度不变。这相当于梁的弯曲变形平面假设。根据这一假设， $ε_z＝γ_{zx}＝γ_{zy}＝0$。因此，在板内所有的点，位移分量$w$只是$x$和$y$的函数而与$z$无关。也就是说，在中面的任意一根法线上，薄板沿厚度方向的所有点都具有挠度$w$。
...
$$
\begin{equation}
D=\frac{E \delta^{3}}{12\left(1-\mu^{2}\right)}
\end{equation}
$$
